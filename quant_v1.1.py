# 프로토타입 버전업(1.0 -> 1.1) - 텔레그램 메시지 전송 기능 추가, 주식 정보 재활용(현재가 업데이트로 정보획득 시간 절약)
...
class KiwoomPy():
    ...
    def updateNowPrice(self, selectDateTime):
        ...
        print("%s의 현재가를 업데이트를 완료하였습니다." % selectDateTime)
        self.send_msg("%s의 현재가를 업데이트를 완료하였습니다." % selectDateTime)
    ...
    def send_msg(self, msg):
        ...
        apiToken = "1005626992:AAFKwJZYyAJd9JLoZWMLKvsY9a4gO4IPB8g"
        chatId = "451041516"
